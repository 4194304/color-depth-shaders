...
const vec3 palette[NUM_COLORS] = vec3[](
    vec3(1.0, 0.33, 0.33),   // Red
    vec3(0.33, 1.0, 0.33),   // Green
    vec3(0.33, 0.33, 1.0),   // Blue
    vec3(1.0, 1.0, 0.33),   // Yellow
    vec3(1.0, 0.33, 1.0),   // Magenta
    vec3(0.33, 1.0, 1.0),   // Cyan
    vec3(0.33, 0.33, 0.33),   // Grey
    vec3(0.66, 0.0, 0.0),   // Dark Red
    vec3(0.0, 0.66, 0.0),   // Dark Green
    vec3(0.0, 0.0, 0.66),   // Dark Blue
    vec3(0.66, 0.33, 0.0),   // Olive
    vec3(0.66, 0.0, 0.66),   // Purple
    vec3(0.0, 0.66, 0.66),   // Teal
    vec3(0.66, 0.66, 0.66),// Light Grey
